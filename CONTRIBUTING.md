...
For detailed platform-specific instructions, refer to the [GEMINI.md](GEMINI.md) file.
...
The release process is handled by the maintainer and is documented in [GEMINI.md](GEMINI.md). Contributors do not need to manage releases, but you can review the process if you're interested in understanding how new versions are published.
