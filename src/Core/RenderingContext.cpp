...
RenderingContext::RenderingContext(obs_source_t *const source, const ILogger &logger, const MainEffect &mainEffect,
	...
	: source_(source),
	  ...
	  selfieSegmenter_(std::make_unique<PPHumansegv2LiteNcnnSelfieSegmenter>(pluginConfig.ppHumansegv2LiteSelfieSegmenterParamPath.c_str(),
								 pluginConfig.ppHumansegv2LiteSelfieSegmenterBinPath.c_str(),
								 numThreads)),
