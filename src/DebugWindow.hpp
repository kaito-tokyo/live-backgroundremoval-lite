...
private:
	...
	std::unique_ptr<KaitoTokyo::BridgeUtils::AsyncTextureReader> readerBgrx;
	std::unique_ptr<KaitoTokyo::BridgeUtils::AsyncTextureReader> readerR8;
	std::unique_ptr<KaitoTokyo::BridgeUtils::AsyncTextureReader> readerR32f;
	std::unique_ptr<KaitoTokyo::BridgeUtils::AsyncTextureReader> reader256Bgrx;
	std::unique_ptr<KaitoTokyo::BridgeUtils::AsyncTextureReader> readerMaskRoiR8;
	std::unique_ptr<KaitoTokyo::BridgeUtils::AsyncTextureReader> readerSubR8;
	std::unique_ptr<KaitoTokyo::BridgeUtils::AsyncTextureReader> readerR32fSub;
