...
RenderingContext::RenderingContext(obs_source_t *_source, const ILogger &_logger, const MainEffect &_mainEffect,
	...
	: source(_source),
	  ...
	  r8GFGuideSub(make_unique_gs_texture(widthSub, heightSub, GS_R8, 1, NULL, GS_RENDER_TARGET)),
	  r8GFSourceSub(make_unique_gs_texture(widthSub, heightSub, GS_R8, 1, NULL, GS_RENDER_TARGET)),
	  r32fGFMeanGuideSub(make_unique_gs_texture(widthSub, heightSub, GS_R32F, 1, NULL, GS_RENDER_TARGET)),
	  r32fGFMeanSourceSub(make_unique_gs_texture(widthSub, heightSub, GS_R32F, 1, NULL, GS_RENDER_TARGET)),
	  r32fGFMeanGuideSourceSub(make_unique_gs_texture(widthSub, heightSub, GS_R32F, 1, NULL, GS_RENDER_TARGET)),
	  r32fGFMeanGuideSqSub(make_unique_gs_texture(widthSub, heightSub, GS_R32F, 1, NULL, GS_RENDER_TARGET)),
	  r32fGFASub(make_unique_gs_texture(widthSub, heightSub, GS_R32F, 1, NULL, GS_RENDER_TARGET)),
	  r32fGFBSub(make_unique_gs_texture(widthSub, heightSub, GS_R32F, 1, NULL, GS_RENDER_TARGET)),
...
void RenderingContext::renderOriginalGrayscale(gs_texture_t *bgrxOriginalImage)
{
	...
	mainEffect.resampleByNearestR8(widthSub, heightSub, r32fSubOriginalGrayscale.get(), r32fOriginalGrayscale.get());
}
...
{
	mainEffect.resampleByNearestR8(widthSub, heightSub, r8GFGuideSub.get(), r16fOriginalGrayscale);

	mainEffect.resampleByNearestR8(widthSub, heightSub, r8GFSourceSub.get(), r8SegmentationMask);

	mainEffect.applyBoxFilterR8KS17(widthSub, heightSub, r32fGFMeanGuideSub.get(), r8GFGuideSub.get(),
					r32fGFTemporary1Sub.get());
	mainEffect.applyBoxFilterR8KS17(widthSub, heightSub, r32fGFMeanSourceSub.get(), r8GFSourceSub.get(),
					r32fGFTemporary1Sub.get());

	mainEffect.applyBoxFilterWithMulR8KS17(widthSub, heightSub, r32fGFMeanGuideSourceSub.get(),
					       r8GFGuideSub.get(), r8GFSourceSub.get(), r32fGFTemporary1Sub.get());
	mainEffect.applyBoxFilterWithSqR8KS17(widthSub, heightSub, r32fGFMeanGuideSqSub.get(), r8GFGuideSub.get(),
					      r32fGFTemporary1Sub.get());

	mainEffect.calculateGuidedFilterAAndB(widthSub, heightSub, r32fGFASub.get(), r32fGFBSub.get(),
