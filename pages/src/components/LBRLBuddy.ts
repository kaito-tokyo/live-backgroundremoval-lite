...
export class LBRLBuddy extends LitElement {
  ...
  private messages: SimpleMessage[] = [
    this.createMessage(
      "assistant",
      `Hi there! I'm ${ASSISTANT_NAME}, your interactive support assistant. Feel free to ask me anything about the knowledge base, and I'll do my best to help you out! 🤖`,
    ),
  ];
