...
4. **Bump Version Files**: Run `.github/scripts/bump_version.sh <new_version>` once you confirm the working tree is clean. This script will update and sync all the version files automatically. Calling this script without the new version will print actual version numbers written in each version file.
