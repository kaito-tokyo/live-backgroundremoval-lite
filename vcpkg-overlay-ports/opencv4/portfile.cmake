...
if("ffmpeg" IN_LIST FEATURES AND VCPKG_TARGET_IS_UWP)
...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DADE_DIR=${CURRENT_INSTALLED_DIR}/share/ade
...
if(VCPKG_TARGET_IS_ANDROID)
  file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/README.android" "${CURRENT_PACKAGES_DIR}/debug/README.android")
endif()
